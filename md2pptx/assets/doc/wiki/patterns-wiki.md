...
### そこで
**閉じる前に、既存の1枚を台木にして接ぐ。**
接いだ相手が入口になり、[[けもの道]] ができる。
台木が無いなら、まだ [[一枚一義]] でない兆候。
...
### そこで
**道は敷かない。踏まれた跡を索引にする。**
どこが踏まれたかは [[接ぎ木]] の跡が教える。
跡から作れば外れない。例が [[index/入口|この索引]]。
...
答えられない問いは、[[種ノート]] にして [[patterns-llm-wiki/問いを置く|置く]]。
