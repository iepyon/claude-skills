...
### 背景: [[intro-llm/任せる理由|第1部 なぜ任せるのか]]
...
![夜間の手入れ](diagrams/patterns-llm/夜間の手入れ.svg)
...
![AIは保守者](diagrams/patterns-llm/AIは保守者.svg)
...
![不変の生データ](diagrams/patterns-llm/不変の生データ.svg)
...
![追記で残す](diagrams/patterns-llm/追記で残す.svg)
...
![人が承認する](diagrams/patterns-llm/人が承認する.svg)
...
![出典まで辿れる](diagrams/patterns-llm/出典まで辿れる.svg)
...
![語彙を寄せる](diagrams/patterns-llm/語彙を寄せる.svg)
...
![規約は走らせる](diagrams/patterns-llm/規約は走らせる.svg)
...
![生成物は直さない](diagrams/patterns-llm/生成物は直さない.svg)
...
![問いを置く](diagrams/patterns-llm/問いを置く.svg)
...
![差分だけ渡す](diagrams/patterns-llm/差分だけ渡す.svg)
...
![書き手を残す](diagrams/patterns-llm/書き手を残す.svg)
