...
### 生む: [釣り竿を渡す](patterns-meta.md#釣り竿を渡す)
...
### そこで
**解に反対する力も書く。**
諦めるものまで書けば、[釣り竿を渡す](patterns-meta.md#釣り竿を渡す) ことになる。
...
自分の状況で、違う形を釣る。図は [ラフで出す](patterns-meta.md#ラフで出す)。
...
本文が [釣り竿を渡す](patterns-meta.md#釣り竿を渡す) と書いても、図が強く残る。
