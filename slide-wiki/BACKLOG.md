...
- 直近の見直し: 2026-08-10（改名後の主題で Wiki のオントロジーとコードを読み直し、B-38〜B-43 を追加）
...
| [B-39](#b-39) | P1 | 効かない場所に書いたリンクを誰も報告しない | Wiki |
| [B-40](#b-40) | P1 | デッキ名が2つの語彙を持つ | Wiki |
| [B-41](#b-41) | P1 | サイトの階層が宣言に無い | オントロジー |
...
| [B-42](#b-42) | P2 | 孤立したスライドを誰も数えない | Wiki |
